...
public class RFilter extends Parser {
	...
	public final StreamContext stream() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -36028975528542218L) != 0)) {
				{
				setState(13);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final ElemContext elem() throws RecognitionException {
		...
		try {
			...
			case T__33:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -36028975528542220L) != 0)) {
					{
					setState(49);
					_errHandler.sync(this);
					switch (_input.LA(1)) {
	...
	public final AtomContext atom() throws RecognitionException {
		...
		try {
			...
			setState(142);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 4548600439272112128L) != 0)) ) {
	...
	public final OpContext op() throws RecognitionException {
		...
		try {
			...
			setState(144);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 4638736205372981216L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
